...
| PL-0003 | P0 | Infra | REVIEW | claude-infra | - | Environment validation | Missing required environment is reported clearly; local PostgreSQL and Redis health are documented |
