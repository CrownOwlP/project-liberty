 ...
 * again in a moment" about a title that does not exist will keep trying. This
 * boundary also carries the 404 status, which is the part every non-human
 * consumer of the route reads.
 */
